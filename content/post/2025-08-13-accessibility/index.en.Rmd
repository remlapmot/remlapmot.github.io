...
It turns out this is because Blackboard scans every document we upload and for some reason Quarto html documents are now too complex and fail this scan. However, there is a workaround.

* First, put your html file into a zip archive
* Then from within your module site, go to Course Content when adding an item
* Select upload Zip archive
* Make sure to select the button to overwrite an existing file with the same name

And that's it. This method seems to bypass the scanning of the html file.
