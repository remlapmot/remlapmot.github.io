...
You can check if a pdf has tags by opening it in Adobe Acrobat Reader then bringing up the document properties - the info is in the bottom left of the _Description_ tab (on Windows I found that SumatraPDF also reported that information but on macOS I found I couldn't see this in Preview).
