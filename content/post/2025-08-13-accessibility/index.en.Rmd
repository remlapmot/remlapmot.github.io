...
If you say add a header to this document that includes an image if you run the Microsoft Accessibility Checker (as detailed in the previous tip) on the document it will give you the option of upgrading the document format to allow you to specify alt text for any images you've added.

And then specify the reference document in your YAML header.
