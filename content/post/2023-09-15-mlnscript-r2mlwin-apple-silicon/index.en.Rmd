...
* First obtain `mlnscript` from the Centre of Multilevel Modelling and then install it, see the relevant page on the MLwiN [webpages](https://www.bristol.ac.uk/cmm/software/mlwin/).
