...
Therefore, we can make this have a taller maximum height by specifying `max-height` as follows in a CSS file which we reference in the YAML header. Note that the default is 400px, so choose a value larger than that.
...
With the contents of _custom.css_ being as follows.
