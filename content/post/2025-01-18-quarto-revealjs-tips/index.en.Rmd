...
tags:
  ...
  - revealjs
subtitle: ''
summary: 'Some tips for making Quarto revealjs presentations including; wider code styling, taller input and output code chunks, embedding Mentimeter presentations, disabling HTML table processing, and programmatic rendering and exporting pdfs for printing.'
authors: []
...
We can also set these globally for the Quarto document in a chunk at the top of your Quarto document as below, but I tend just to do this on chunks in which I know I have wide code.
...
Currently, there doesn't seem to be a Quarto option to make the code output chunks taller. Therefore I had to inspect the source code the html slides. In most browsers simply right click on a slide and in Chrome click _Inspect_ - do this over the element on the page you want to find out about.
...
<img src="/post/2025/quarto-revealjs-tips/img/inspect-output-cell.png" alt="Screenshot of Google Chrome context menu." width="630" style="display: block; margin: auto;">
