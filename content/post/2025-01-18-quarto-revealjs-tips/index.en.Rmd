...
To render a Quarto document we can click the _Render_ button in RStudio, but I find it easier to keep a _render.R_ script with a call to `quarto::quarto_render()`.
