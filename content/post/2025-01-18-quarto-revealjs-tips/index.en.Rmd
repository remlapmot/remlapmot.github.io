...
tags:
  ...
  - revealjs
subtitle: ''
summary: 'Wider code styling, taller input and output code chunks, embedding Mentimeter presentations, and disabling HTML table processing.'
authors: []
...
<iframe sandbox='allow-scripts allow-same-origin allow-presentation' allowfullscreen='true' allowtransparency='true' frameborder='0' height='315' src='https://www.mentimeter.com/app/presentation/###############/embed' style='position: absolute; top: 0; left: 0; width: 100%; height: 100%;' width='420'>
</iframe>
</div>
```
...
<img src="/post/2025/quarto-revealjs-tips/img/menti-failing-to-load.gif" alt="Animated GIF of the spinning dots when a Mentimeter presentation is incorrectly embedded in an HTML document." width="630" style="display: block; margin: auto;">
