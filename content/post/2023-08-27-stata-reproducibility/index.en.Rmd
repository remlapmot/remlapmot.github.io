...
In summary, my `reffadjustsim` command works again for MLwiN/`runmlwin` models. The updated version is available from [its GitHub repo](https://github.com/remlapmot/reffadjust). And if you ever need *fuller* reproducibility in your Stata do-file or program remember to set both the version and the user version.
