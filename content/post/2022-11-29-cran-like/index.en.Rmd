...
You can either run a local webserver or use the `file://...` URL notation as your `repos` global options setting (set with `option(repos = c(CRAN = "..."))` or as the `repos` argument to `install.packages()`).
