...
The r-hub API does not yet provide the installer information for the AARCH64 version of R, so I came up with the following workflow file - amended from r-lib/actions to install R 4.5.0 and RTools45.
...
To confirm we really have launched the AARCH64 version of R we see the output of `R.version` is as follows.
...
I have shown how to install the AARCH64 version of R and RTools45 on Windows on ARM within GitHub Actions.
