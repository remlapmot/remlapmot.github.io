...
In the following examples I assume we are creating an R script, _render.R_, which contains one or more calls to `quarto::quarto_render()` for a lecture or tutorial. Hence, for the dependency R packages I include the required list of packages and the quarto and knitr packages.
