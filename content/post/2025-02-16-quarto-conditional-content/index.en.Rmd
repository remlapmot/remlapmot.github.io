...
[Nicola Rennie approach](https://nrennie.rbind.io/blog/r-tutorial-worksheets-quarto/):
...
Remarkably we can also do this with a pure Quarto approach with the `! expr ...` notation.
