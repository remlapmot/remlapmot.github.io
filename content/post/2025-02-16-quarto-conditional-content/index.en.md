...
The code described below is presented in the following [demo repo](https://github.com/remlapmot/quarto-parameterised-reports-test), and the rendered output files can also [be viewed](https://remlapmot.github.io/quarto-parameterised-reports-test/).
