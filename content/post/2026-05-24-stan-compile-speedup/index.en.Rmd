...
Then switch to `clang` in your _~/.R/Makevars_ file (if you're not using `ccache` delete that prefix)
...
I believe you need `clang` version 18 to see the speedups (I had 18.1.3).
