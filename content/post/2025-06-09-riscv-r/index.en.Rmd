...
A little bit to my surprise this worked. And I was presented with the login to Ubuntu server. The default username is _ubuntu_ and the default password is _ubuntu_.
