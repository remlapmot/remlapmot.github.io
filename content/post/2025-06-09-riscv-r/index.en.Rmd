...
I don't have a RISC-V computer, although developer boards are now available for a reasonable price, there aren't yet any competitive desktop machines. Therefore, I needed to emulation.
...
I wondered whether to try [UTM](https://mac.getutm.app/) or [Qemu](https://www.qemu.org/). I tried UTM first but I couldn't make any progress. So I found a tip online saying that RISC-V Ubuntu could be launched under Qemu on Ubuntu Linux using the following command.
